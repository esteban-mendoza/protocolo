...
\begin{document}
	...
	\begin{itemize}
		\item nDCG@10 \parencite{thakur2021beirheterogenousbenchmarkzeroshot,muennighoff2023mteb,zhang2023miracl,valentini-etal-2025-messirve,craswell2020overview}, dada su capacidad para modelar relevancia graduada con descuento logarítmico por posición, lo que la convierte en el estándar dominante en los \textit{benchmarks} de recuperación modernos;
		\item Recall@100 \parencite{zhang2023miracl,valentini-etal-2025-messirve,zhang2021mrtydi}, al ser la métrica que cuantifica la cobertura de la etapa de recuperación inicial y establece el techo de rendimiento para cualquier etapa de reordenamiento posterior;
		\item MRR@10 \parencite{nguyen2016msmarco,zhang2021mrtydi}, para evaluar la utilidad estricta del primer documento relevante recuperado;
		...
		\item Precision@$k$ para $k \in \{10, 50\}$ \parencite{craswell2020overview,voorhees2021treccovid}, con el fin de analizar el decaimiento de la precisión conforme se amplía la ventana de observación.
	\end{itemize}
	La elección de esta batería de métricas responde a la necesidad de garantizar comparabilidad directa con los protocolos de evaluación adoptados por los \textit{benchmarks} del estado del arte: BEIR \parencite{thakur2021beirheterogenousbenchmarkzeroshot}, MTEB \parencite{muennighoff2023mteb}, MIRACL \parencite{zhang2023miracl}, \textsc{MessIRve} \parencite{valentini-etal-2025-messirve}, TREC Deep Learning \parencite{craswell2020overview}, MS MARCO \parencite{nguyen2016msmarco}, Mr.\ TyDi \parencite{zhang2021mrtydi} y TREC-COVID \parencite{voorhees2021treccovid}, permitiendo así contrastar los resultados obtenidos con las líneas base reportadas en la literatura bajo condiciones metodológicamente equivalentes.
